...
<!-- Plain list; add entries newest-first. If your notes app supports queries (e.g. Obsidian Dataview), replace this with a query over the drafts folder. -->

- (none yet)

## Related

- email style guide (`email.md`)
